    ...
    public partial class seedingdatafordifficultiesandregions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("be5ac3f8-3725-4a4d-8e4d-8c40197f4dca"), "Easy" },
                    { new Guid("f0bac12e-ce56-4570-8940-c8759f44660a"), "Meduim" },
                    { new Guid("fb4b51f5-b3fa-4eb1-8e69-6d40e406eb0b"), "Hard" }
                });

            migrationBuilder.InsertData(
                table: "Regions",
                columns: new[] { "Id", "Code", "Name", "RegionImage" },
                values: new object[,]
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("be5ac3f8-3725-4a4d-8e4d-8c40197f4dca"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("f0bac12e-ce56-4570-8940-c8759f44660a"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("fb4b51f5-b3fa-4eb1-8e69-6d40e406eb0b"));
